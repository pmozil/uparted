...
#endif
#if (202311 <= __STDC_VERSION__ || (!defined __STRICT_ANSI__ && 9 <= __GNUC__))
...
#define _GL_VERIFY(R, DIAGNOSTIC, ...)                                         \
    extern int(*_GL_GENSYM(_gl_verify_function)(                               \
        void))[_GL_VERIFY_TRUE(R, DIAGNOSTIC)]
...
#define _Static_assert(R, ...) _GL_VERIFY((R), "static assertion failed", -)
#endif
#endif
/* Define static_assert if needed.  */
#if (!defined static_assert && __STDC_VERSION__ < 202311 &&                    \
     (!defined __cplusplus ||                                                  \
