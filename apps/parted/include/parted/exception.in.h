...
extern char *
ped_exception_get_type_string(PedExceptionType ex_type) _GL_ATTRIBUTE_CONST;
extern char *
ped_exception_get_option_string(PedExceptionOption ex_opt) _GL_ATTRIBUTE_PURE;

extern void ped_exception_set_handler(PedExceptionHandler *handler);
extern PedExceptionHandler *ped_exception_get_handler(void) _GL_ATTRIBUTE_PURE;
