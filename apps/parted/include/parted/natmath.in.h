...
extern PedSector ped_round_up_to(PedSector sector,
                                 PedSector grain_size) _GL_ATTRIBUTE_CONST;
extern PedSector ped_round_down_to(PedSector sector,
                                   PedSector grain_size) _GL_ATTRIBUTE_CONST;
extern PedSector ped_round_to_nearest(PedSector sector,
                                      PedSector grain_size) _GL_ATTRIBUTE_CONST;
extern PedSector ped_greatest_common_divisor(PedSector a,
                                             PedSector b) _GL_ATTRIBUTE_PURE;
