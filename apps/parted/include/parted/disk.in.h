...
/* Include these to work around gnulib redefining free, read, etc. which causes
 * problems with pt-common.h
 */
#include <stdint.h>
#include <stdlib.h>
#include <unistd.h>
...
extern PedDiskType *
ped_disk_type_get_next(PedDiskType const *type) _GL_ATTRIBUTE_PURE;
extern PedDiskType *ped_disk_type_get(const char *name) _GL_ATTRIBUTE_PURE;
extern int
ped_disk_type_check_feature(const PedDiskType *disk_type,
                            PedDiskTypeFeature feature) _GL_ATTRIBUTE_PURE;
...
extern int
ped_disk_get_primary_partition_count(const PedDisk *disk) _GL_ATTRIBUTE_PURE;
extern int
ped_disk_get_last_partition_num(const PedDisk *disk) _GL_ATTRIBUTE_PURE;
...
extern const char *
ped_partition_type_get_name(PedPartitionType part_type) _GL_ATTRIBUTE_CONST;
...
extern PedPartitionFlag
ped_partition_flag_next(PedPartitionFlag flag) _GL_ATTRIBUTE_CONST;
...
extern PedPartition *
ped_disk_next_partition(const PedDisk *disk,
                        const PedPartition *part) _GL_ATTRIBUTE_PURE;
extern PedPartition *ped_disk_get_partition(const PedDisk *disk,
                                            int num) _GL_ATTRIBUTE_PURE;
extern PedPartition *
ped_disk_get_partition_by_sector(const PedDisk *disk,
                                 PedSector sect) _GL_ATTRIBUTE_PURE;
extern PedPartition *
ped_disk_extended_partition(const PedDisk *disk) _GL_ATTRIBUTE_PURE;
...
extern int _ped_partition_attempt_align(PedPartition *part,
