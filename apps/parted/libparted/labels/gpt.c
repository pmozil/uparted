...
#define PARTITION_SYSTEM_GUID                                                  \
    ((efi_guid_t){PED_CPU_TO_LE32(0xC12A7328),                                 \
                  PED_CPU_TO_LE16(0xF81F),                                     \
                  PED_CPU_TO_LE16(0x11d2),                                     \
                  0xBA,                                                        \
                  0x4B,                                                        \
                  {0x00, 0xA0, 0xC9, 0x3E, 0xC9, 0x3B}})
#define PARTITION_BIOS_GRUB_GUID                                               \
    ((efi_guid_t){PED_CPU_TO_LE32(0x21686148),                                 \
                  PED_CPU_TO_LE16(0x6449),                                     \
                  PED_CPU_TO_LE16(0x6E6f),                                     \
                  0x74,                                                        \
                  0x4E,                                                        \
...
#define PARTITION_MSFT_RESERVED_GUID                                           \
    ((efi_guid_t){PED_CPU_TO_LE32(0xE3C9E316),                                 \
                  PED_CPU_TO_LE16(0x0B5C),                                     \
                  PED_CPU_TO_LE16(0x4DB8),                                     \
                  0x81,                                                        \
                  0x7D,                                                        \
                  {0xF9, 0x2D, 0xF0, 0x02, 0x15, 0xAE}})
#define PARTITION_MSFT_RECOVERY                                                \
    ((efi_guid_t){PED_CPU_TO_LE32(0xDE94BBA4),                                 \
                  PED_CPU_TO_LE16(0x06D1),                                     \
                  PED_CPU_TO_LE16(0x4D40),                                     \
                  0xA1,                                                        \
                  0x6A,                                                        \
                  {0xBF, 0xD5, 0x01, 0x79, 0xD6, 0xAC}})
#define PARTITION_BASIC_DATA_GUID                                              \
    ((efi_guid_t){PED_CPU_TO_LE32(0xEBD0A0A2),                                 \
                  PED_CPU_TO_LE16(0xB9E5),                                     \
                  PED_CPU_TO_LE16(0x4433),                                     \
                  0x87,                                                        \
                  0xC0,                                                        \
                  {0x68, 0xB6, 0xB7, 0x26, 0x99, 0xC7}})
#define PARTITION_RAID_GUID                                                    \
    ((efi_guid_t){PED_CPU_TO_LE32(0xa19d880f),                                 \
                  PED_CPU_TO_LE16(0x05fc),                                     \
                  PED_CPU_TO_LE16(0x4d3b),                                     \
                  0xa0,                                                        \
                  0x06,                                                        \
                  {0x74, 0x3f, 0x0f, 0x84, 0x91, 0x1e}})
#define PARTITION_SWAP_GUID                                                    \
    ((efi_guid_t){PED_CPU_TO_LE32(0x0657fd6d),                                 \
                  PED_CPU_TO_LE16(0xa4ab),                                     \
                  PED_CPU_TO_LE16(0x43c4),                                     \
                  0x84,                                                        \
                  0xe5,                                                        \
                  {0x09, 0x33, 0xc8, 0x4b, 0x4f, 0x4f}})
#define PARTITION_LINUX_DATA_GUID                                              \
    ((efi_guid_t){PED_CPU_TO_LE32(0x0FC63DAF),                                 \
                  PED_CPU_TO_LE16(0x8483),                                     \
                  PED_CPU_TO_LE16(0x4772),                                     \
                  0x8E,                                                        \
                  0x79,                                                        \
                  {0x3D, 0x69, 0xD8, 0x47, 0x7D, 0xE4}})
#define PARTITION_LVM_GUID                                                     \
    ((efi_guid_t){PED_CPU_TO_LE32(0xe6d6d379),                                 \
                  PED_CPU_TO_LE16(0xf507),                                     \
                  PED_CPU_TO_LE16(0x44c2),                                     \
                  0xa2,                                                        \
                  0x3c,                                                        \
                  {0x23, 0x8f, 0x2a, 0x3d, 0xf9, 0x28}})
#define PARTITION_RESERVED_GUID                                                \
    ((efi_guid_t){PED_CPU_TO_LE32(0x8da63339),                                 \
                  PED_CPU_TO_LE16(0x0007),                                     \
                  PED_CPU_TO_LE16(0x60c0),                                     \
                  0xc4,                                                        \
                  0x36,                                                        \
                  {0x08, 0x3a, 0xc8, 0x23, 0x09, 0x08}})
#define PARTITION_HPSERVICE_GUID                                               \
    ((efi_guid_t){PED_CPU_TO_LE32(0xe2a1e728),                                 \
                  PED_CPU_TO_LE16(0x32e3),                                     \
                  PED_CPU_TO_LE16(0x11d6),                                     \
                  0xa6,                                                        \
                  0x82,                                                        \
                  {0x7b, 0x03, 0xa0, 0x00, 0x00, 0x00}})
#define PARTITION_APPLE_HFS_GUID                                               \
    ((efi_guid_t){PED_CPU_TO_LE32(0x48465300),                                 \
                  PED_CPU_TO_LE16(0x0000),                                     \
                  PED_CPU_TO_LE16(0x11AA),                                     \
                  0xaa,                                                        \
                  0x11,                                                        \
                  {0x00, 0x30, 0x65, 0x43, 0xEC, 0xAC}})
#define PARTITION_APPLE_TV_RECOVERY_GUID                                       \
    ((efi_guid_t){PED_CPU_TO_LE32(0x5265636F),                                 \
                  PED_CPU_TO_LE16(0x7665),                                     \
                  PED_CPU_TO_LE16(0x11AA),                                     \
                  0xaa,                                                        \
                  0x11,                                                        \
                  {0x00, 0x30, 0x65, 0x43, 0xEC, 0xAC}})
#define PARTITION_PREP_GUID                                                    \
    ((efi_guid_t){PED_CPU_TO_LE32(0x9e1a2d38),                                 \
                  PED_CPU_TO_LE16(0xc612),                                     \
                  PED_CPU_TO_LE16(0x4316),                                     \
                  0xaa,                                                        \
                  0x26,                                                        \
                  {0x8b, 0x49, 0x52, 0x1e, 0x5a, 0x8b}})
#define PARTITION_IRST_GUID                                                    \
    ((efi_guid_t){PED_CPU_TO_LE32(0xD3BFE2DE),                                 \
                  PED_CPU_TO_LE16(0x3DAF),                                     \
                  PED_CPU_TO_LE16(0x11DF),                                     \
                  0xba,                                                        \
                  0x40,                                                        \
                  {0xE3, 0xA5, 0x56, 0xD8, 0x95, 0x93}})
#define PARTITION_CHROMEOS_KERNEL_GUID                                         \
    ((efi_guid_t){PED_CPU_TO_LE32(0xfe3a2a5d),                                 \
                  PED_CPU_TO_LE16(0x4f32),                                     \
                  PED_CPU_TO_LE16(0x41a7),                                     \
                  0xb7,                                                        \
                  0x25,                                                        \
                  {0xac, 0xcc, 0x32, 0x85, 0xa3, 0x09}})
#define PARTITION_BLS_BOOT_GUID                                                \
    ((efi_guid_t){PED_CPU_TO_LE32(0xbc13c2ff),                                 \
                  PED_CPU_TO_LE16(0x59e6),                                     \
                  PED_CPU_TO_LE16(0x4262),                                     \
                  0xa3,                                                        \
                  0x52,                                                        \
                  {0xb2, 0x75, 0xfd, 0x6f, 0x71, 0x72}})
#define PARTITION_LINUX_HOME_GUID                                              \
    ((efi_guid_t){PED_CPU_TO_LE32(0x933ac7e1),                                 \
                  PED_CPU_TO_LE16(0x2eb4),                                     \
                  PED_CPU_TO_LE16(0x4f13),                                     \
                  0xb8,                                                        \
                  0x44,                                                        \
...
#define GPT_DEFAULT_PARTITION_ENTRIES                                          \
    (GPT_DEFAULT_PARTITION_ENTRY_ARRAY_SIZE / sizeof(GuidPartitionEntry_t))
...
static inline uint32_t pth_get_size(const PedDevice *dev) {
    return GPT_HEADER_SECTORS * dev->sector_size;
}

static inline uint32_t pth_get_size_static(const PedDevice *dev) {
    return sizeof(GuidPartitionTableHeader_t) - sizeof(uint8_t *);
}

static inline uint32_t pth_get_size_rsv2(const PedDevice *dev) {
    return pth_get_size(dev) - pth_get_size_static(dev);
}

static GuidPartitionTableHeader_t *pth_new(const PedDevice *dev) {
...
static GuidPartitionTableHeader_t *pth_new_zeroed(const PedDevice *dev) {
...
static GuidPartitionTableHeader_t *pth_new_from_raw(const PedDevice *dev,
                                                    const uint8_t *pth_raw) {
    GuidPartitionTableHeader_t *pth = pth_new(dev);
...
static void pth_free(GuidPartitionTableHeader_t *pth) {
    if (pth == NULL)
        return;
...
static uint8_t *pth_get_raw(const PedDevice *dev,
                            const GuidPartitionTableHeader_t *pth) {
    PED_ASSERT(pth != NULL);
    PED_ASSERT(pth->Reserved2 != NULL);
 ...
 */
static inline uint32_t efi_crc32(const void *buf, unsigned long len) {
...
static int pth_crc32(const PedDevice *dev,
                     const GuidPartitionTableHeader_t *pth, uint32_t *crc32) {
    PED_ASSERT(dev != NULL);
    PED_ASSERT(pth != NULL);
...
static inline int _GL_ATTRIBUTE_PURE _pmbr_is_valid(const LegacyMBR_t *mbr) {
    int i;
...
static PedDisk *gpt_duplicate(const PedDisk *disk) {
    PedDisk *new_disk;
...
static void gpt_free(PedDisk *disk) {
...
static void *gpt_read_PE_array(PedDisk const *disk,
                               GuidPartitionTableHeader_t const *gpt,
                               size_t *ptes_bytes) {
    ...
    *ptes_bytes = p_ent_size * PED_LE32_TO_CPU(gpt->NumberOfPartitionEntries);
    size_t ptes_sectors = ped_div_round_up(*ptes_bytes, disk->dev->sector_size);
...
static int check_PE_array_CRC(PedDisk const *disk,
                              GuidPartitionTableHeader_t const *gpt,
                              bool *valid) {
    size_t ptes_bytes;
...
static int _header_is_valid(PedDisk const *disk,
                            GuidPartitionTableHeader_t *gpt, PedSector my_lba) {
    ...
    if (pe_size % 8 != 0 || !(sizeof(GuidPartitionEntry_t) <= pe_size &&
 ...
 */
static PedSector _ptes_sectors(PedDisk const *disk,
                               GuidPartitionTableHeader_t const *gpt) {
 ...
 */
static PedSector _hdr_disk_end(PedDisk const *disk,
                               GuidPartitionTableHeader_t const *gpt) {
    return PED_LE64_TO_CPU(gpt->LastUsableLBA) + 1 + _ptes_sectors(disk, gpt);
}

static int _parse_header(PedDisk *disk, const GuidPartitionTableHeader_t *gpt,
                         int *update_needed) {
    ...
    /* Need to check whether the volume has grown, the LastUsableLBA is
       ...
       greater. If the volume has grown, offer the user the chance to use the
       new space or continue with the current usable area.  Only ask once per
       parted invocation. */

    last_usable_if_grown = disk->dev->length - 2 - _ptes_sectors(disk, gpt);

    if (last_usable <= first_usable || disk->dev->length < last_usable)
        return 0;
    ...
    if (last_usable < last_usable_if_grown) {
        ...
        q = ped_exception_throw(
            PED_EXCEPTION_WARNING, PED_EXCEPTION_FIX | PED_EXCEPTION_IGNORE,
            _("Not all of the space available to %s appears "
              ...
              "current setting? "),
            disk->dev->path, (uint64_t)(last_usable_if_grown - last_usable));

        if (q == PED_EXCEPTION_FIX) {
            last_usable = last_usable_if_grown;
            /* clear the old backup gpt header */
            ptt_clear_sectors(disk->dev, gpt_disk_data->AlternateLBA, 1);
            gpt_disk_data->AlternateLBA = disk->dev->length - 1;
            *update_needed = 1;
        }
    }

    ped_geometry_init(&gpt_disk_data->data_area, disk->dev, first_usable,
                      last_usable - first_usable + 1);

    gpt_disk_data->entry_count = PED_LE32_TO_CPU(gpt->NumberOfPartitionEntries);
...
static PedPartition *_parse_part_entry(PedDisk *disk,
...
static int gpt_read_headers(PedDisk const *disk,
    ...
    *backup_gpt = NULL;
    ...
    gpt_disk_data->AlternateLBA =
        (valid_primary ? PED_LE64_TO_CPU(pri->AlternateLBA) : dev->length - 1);
...
static int gpt_read(PedDisk *disk) {
    ...
    int read_failure =
        gpt_read_headers(disk, &primary_gpt, &backup_gpt, &backup_sector_num);
    if (read_failure) {
    ...
    if (primary_gpt && backup_gpt) {
        /* Both are valid.  */
#ifndef DISCOVER_ONLY
        /* The backup header must be at the end of the disk, or at what the
         * primary header thinks is the end of the disk.
         */
        gpt_disk_data->AlternateLBA =
            PED_LE64_TO_CPU(primary_gpt->AlternateLBA);
        ...
        if (gpt_disk_data->AlternateLBA != disk->dev->length - 1 &&
            ...
            if (ped_exception_throw(
                    ...
                    _("The backup GPT table is not at the end of the disk, as "
                      "it "
                      "should be.  Fix, by moving the backup to the end "
                      "(and removing the old backup)?")) == PED_EXCEPTION_FIX) {
                ptt_clear_sectors(
                    disk->dev, PED_LE64_TO_CPU(primary_gpt->AlternateLBA), 1);
                gpt_disk_data->AlternateLBA = disk->dev->length - 1;
                write_back = 1;
            }
        }
...
static int _write_pmbr(PedDevice *dev, bool pmbr_boot) {
    ...
    int write_ok = ped_device_write(dev, pmbr, GPT_PMBR_LBA, GPT_PMBR_SECTORS);
    free(s0);
    return write_ok;
}

static int _generate_header(const PedDisk *disk, int alternate,
                            uint32_t ptes_crc,
    ...
    *gpt_p = pth_new_zeroed(disk->dev);
    ...
    if (alternate) {
        ...
        PedSector ptes_bytes =
            (gpt_disk_data->entry_count * sizeof(GuidPartitionEntry_t));
    ...
    gpt->NumberOfPartitionEntries = PED_CPU_TO_LE32(gpt_disk_data->entry_count);
...
static void _partition_generate_part_entry(PedPartition *part,
                                           GuidPartitionEntry_t *pte) {
...
static int gpt_write(const PedDisk *disk) {
    ...
    if (pth_raw == NULL)
        goto error_free_ptes;
    write_ok =
        ped_device_write(disk->dev, pth_raw, gpt_disk_data->AlternateLBA, 1);
    free(pth_raw);
    if (!write_ok)
        goto error_free_ptes;
    if (!ped_device_write(disk->dev, ptes,
                          gpt_disk_data->AlternateLBA - ptes_sectors,
                          ptes_sectors))
        goto error_free_ptes;
...
static int add_metadata_part(PedDisk *disk, PedSector start, PedSector length) {
    PedPartition *part;
    PedConstraint *constraint_exact;
    PED_ASSERT(disk != NULL);

    part = ped_partition_new(disk, PED_PARTITION_METADATA, NULL, start,
                             start + length - 1);
    if (!part)
        goto error;
...
static PedPartition *gpt_partition_new(const PedDisk *disk,
    ...
    gpt_part_data = part->disk_specific = ped_malloc(sizeof(GPTPartitionData));
    if (!gpt_part_data)
...
static PedPartition *gpt_partition_duplicate(const PedPartition *part) {
    PedPartition *result;
    ...
    result_data = result->disk_specific = ped_malloc(sizeof(GPTPartitionData));
    if (!result_data)
        goto error_free_part;
 ...
 */
static bool is_skip_guid(efi_guid_t guid) {
...
static int gpt_partition_set_system(PedPartition *part,
                                    const PedFileSystemType *fs_type) {
    GPTPartitionData *gpt_part_data = part->disk_specific;
...
static int gpt_disk_set_flag(PedDisk *disk, PedDiskFlag flag, int state) {
    GPTDiskData *gpt_disk_data = disk->disk_specific;
    switch (flag) {
...
static int gpt_disk_is_flag_available(const PedDisk *disk, PedDiskFlag flag) {
    switch (flag) {
    case PED_DISK_GPT_PMBR_BOOT:
        return 1;
    default:
...
static uint8_t *gpt_disk_get_uuid(const PedDisk *disk) {
    GPTDiskData *gpt_disk_data = disk->disk_specific;
...
static int gpt_disk_get_flag(const PedDisk *disk, PedDiskFlag flag) {
    GPTDiskData *gpt_disk_data = disk->disk_specific;
    switch (flag) {
    case PED_DISK_GPT_PMBR_BOOT:
...
static int gpt_partition_set_flag(PedPartition *part, PedPartitionFlag flag,
                                  int state) {
    GPTPartitionData *gpt_part_data;
    ...
    if (p) {
        if (state) {
            ...
            // Clear the GUID so that fs_type will be used to return it to the
            // default
            gpt_part_data->type = PARTITION_LINUX_DATA_GUID;
...
static int _GL_ATTRIBUTE_PURE gpt_partition_get_flag(const PedPartition *part,
...
static void gpt_partition_set_name(PedPartition *part, const char *name) {
    GPTPartitionData *gpt_part_data = part->disk_specific;
...
static int gpt_partition_set_type_uuid(PedPartition *part,
                                       const uint8_t *uuid) {
    GPTPartitionData *gpt_part_data = part->disk_specific;
...
static uint8_t *gpt_partition_get_type_uuid(const PedPartition *part) {
...
static uint8_t *gpt_partition_get_uuid(const PedPartition *part) {
    const GPTPartitionData *gpt_part_data = part->disk_specific;
 ...
 */
static bool gpt_get_max_supported_partition_count(const PedDisk *disk,
                                                  int *max_n) {
    ...
    *max_n =
        (disk->dev->sector_size * (PED_LE64_TO_CPU(pth->FirstUsableLBA) - 2) /
         PED_LE32_TO_CPU(pth->SizeOfPartitionEntry));
    pth_free(pth);
    return true;
}

static PedConstraint *_non_metadata_constraint(const PedDisk *disk) {
    GPTDiskData *gpt_disk_data = disk->disk_specific;
...
static PedDiskType gpt_disk_type = {
    ...
    ops : &gpt_disk_ops,
    features :
            PED_DISK_TYPE_PARTITION_NAME | PED_DISK_TYPE_PARTITION_TYPE_UUID |
        PED_DISK_TYPE_DISK_UUID | PED_DISK_TYPE_PARTITION_UUID
};

void ped_disk_gpt_init() { ped_disk_type_register(&gpt_disk_type); }

void ped_disk_gpt_done() { ped_disk_type_unregister(&gpt_disk_type); }
