...
#define PT_define_limit_functions(PT_type)                                     \
                                                                               \
    static bool PT_type##_partition_check(const PedPartition *part) {          \
        return ptt_partition_max_start_len(#PT_type, part);                    \
    }                                                                          \
                                                                               \
    static PedSector PT_type##_partition_max_start_sector(void) {              \
        PedSector max;                                                         \
        ...
        return max;                                                            \
                                                                               ...
                                                                               \
    static PedSector PT_type##_partition_max_length(void) {                    \
        PedSector max;                                                         \
