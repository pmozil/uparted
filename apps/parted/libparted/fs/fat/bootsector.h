...
#define FAT_BOOT_MESSAGE                                                       \
  "This partition does not have an operating system loader installed on "      \
  "it.\n\r"                                                                    \
...
#define FAT_BOOT_CODE                                                          \
  "\x0e"                                      /* push cs */                    \
  "\x1f"                                      /* pop ds */                     \
  "\xbe\x74\x7e" /* mov si, offset message */ /* write_msg_loop: */            \
  "\xac"                                      /* lodsb */                      \
  "\x22\xc0"                                  /* and al, al */                 \
  "\x74\x06"                                  /* jz done (+8) */               \
  "\xb4\x0e"                                  /* mov ah, 0x0e */               \
  "\xcd\x10"                                  /* int 0x10 */                   \
  "\xeb\xf5" /* jmp write_msg_loop */         /* done: */                      \
  "\xb4\x00"                                  /* mov ah, 0x00 */               \
  "\xcd\x16"                                  /* int 0x16 */                   \
  "\xb4\x00"                                  /* mov ah, 0x00 */               \
  "\xcd\x19"                                  /* int 0x19 */                   \
  "\xeb\xfe" /* jmp +0 - in case int 0x19 */ /* doesn't work */ /* message: */ \
      FAT_BOOT_MESSAGE
