...
#define HFS_16_TO_CPU(x, is_little_endian)                                     \
    ((is_little_endian) ? (uint16_t)PED_LE16_TO_CPU(x)                         \
                        : (uint16_t)PED_BE16_TO_CPU(x))
#define HFS_32_TO_CPU(x, is_little_endian)                                     \
    ((is_little_endian) ? (uint32_t)PED_LE32_TO_CPU(x)                         \
                        : (uint32_t)PED_BE32_TO_CPU(x))
#define HFS_64_TO_CPU(x, is_little_endian)                                     \
    ((is_little_endian) ? (uint64_t)PED_LE64_TO_CPU(x)                         \
                        : (uint64_t)PED_BE64_TO_CPU(x))
#define HFS_CPU_TO_16(x, is_little_endian)                                     \
    ((is_little_endian) ? (uint16_t)PED_CPU_TO_LE16(x)                         \
                        : (uint16_t)PED_CPU_TO_BE16(x))
#define HFS_CPU_TO_32(x, is_little_endian)                                     \
    ((is_little_endian) ? (uint32_t)PED_CPU_TO_LE32(x)                         \
                        : (uint32_t)PED_CPU_TO_BE32(x))
#define HFS_CPU_TO_64(x, is_little_endian)                                     \
    ((is_little_endian) ? (uint64_t)PED_CPU_TO_LE64(x)                         \
                        : (uint64_t)PED_CPU_TO_BE64(x))
