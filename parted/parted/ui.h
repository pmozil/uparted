...
enum AlignmentType { PA_MINIMUM = 1, PA_OPTIMUM };
...
extern int non_interactive_mode(PedDevice **dev, PedDisk **disk,
                                Command *cmd_list[], int argc, char *argv[]);
...
extern int command_line_get_disk_flag(const char *prompt, const PedDisk *disk,
                                      PedDiskFlag *flag);
